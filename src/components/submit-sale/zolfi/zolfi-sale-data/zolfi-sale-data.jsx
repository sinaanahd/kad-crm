...
import Product from "../../sale-data/product/product";
import CartProduct from "../../sale-data/cart-products/cart-product";
import { DataContext } from "../../../data/datacontext";
const ZolfiSaleData = ({ selected_user, set_sale, set_products, products }) => {
  ...
  const send_zolfi_sale_data = () => {
    if (cart && selected_user) {
      const send_obj = {
        buyer_phone_number: selected_user.phone_number,
        products_ids: cart.products_ids,
      };
      ...
      <div className="cart-col box-style">
        ...
        <div className="total-price-wrapper">
          ...
          <span className="total-price-num">
            {cart
              ? split_in_three(
                  convert_to_persian(cart.products_ids.length * 975000)
                )
        ...
        {pause ? (
          ...
          <button className="submit-btn" onClick={send_zolfi_sale_data}>
            ثبت اطلاعات
          </button>
        )}
      </div>
